...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AFP Portfolio Intelligence" },
      { name: "description", content: "Institutional analytics dashboard for the Colombian AFP market." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "AFP Portfolio Intelligence" },
      { property: "og:description", content: "Institutional analytics dashboard for the Colombian AFP market." },
